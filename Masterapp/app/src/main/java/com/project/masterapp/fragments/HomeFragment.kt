...
class HomeFragment( private val context: HomeActivity) : Fragment(
    ...
    override fun onCreateView(
        ...
        horizontalRecyclerView?.adapter = PlantAdapter(context,PlantRepository.Singleton.plantList, R.layout.item_horizontal_plant)

        val verticalRecyclerView = view?.findViewById<RecyclerView>(R.id.vertical_recycler_view)
        verticalRecyclerView?.adapter = PlantAdapter(context, PlantRepository.Singleton.plantList.filter{ !it.watered }, R.layout.item_vertical_plant)
